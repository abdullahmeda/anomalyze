...
ANOMALY = {
    ...
    "description": "3× volume spike with characteristic skew (simulates major outage/bug)",
}
...
def assign_timestamps(
    ...
    total_normal = sum(normal_volumes.values())
...
def export_datasets(df: pd.DataFrame, metadata: dict):
    """Export train/test CSVs and metadata JSON."""
